...
def generate_launch_description():
    ...
    if EnvironmentVariable('GAZEBO_RESOURCE_PATH'):
    ...
    ld = LaunchDescription([
        SetEnvironmentVariable(name='GAZEBO_RESOURCE_PATH', value='/usr/share/gazebo-11/:/home/char/turtlebot3_ws/src/metr4202_aruco_explore/resource'),
